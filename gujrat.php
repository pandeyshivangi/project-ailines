...
<html>
<head>
	<title>Gujarat and Goa Packages</title>
...
<img src="guj.jpg">
<img src="Capture1.PNG" style="position:absolute;z-index:1;top:70;right:100">
</div>

<br><br>
<br><br>
<h1 style="color: #1A1F71;text-align: center;">Gujarat and Goa</h1>
<br><p style="color: #5C5C5C;text-align: center; font-size: 30px;">
    Gujarat, India's westernmost state, has varied terrain and numerous sacred sites. In its urban center of Ahmedabad is the Calico Museum of Textiles, displaying antique and modern Indian fabrics.<br>
...
<p style="color: #5C5C5C;text-align: center; font-size: 30px;">
    The local currency in Gujarat and Goa is the Indian Rupees (INR).<br>
...
<div style="background-color: #1A1F71">
	<br><h2 style="color: #fc0;text-align: center;">Need help in Gujarat and Goa?</h2>
	<br><br>
	<div style="color: white;text-align: center;font-size:20px">SeleQtion's Global Customer Assistance Service is available 24 hours a day, 7 days a week. <br><br> In Gujarat and Goa, call our freephone number: Access Code 8000 121 then 866 654 0112<br><br> Or call +1 303 967 1090 from anywhere in the world. </div><br><br>
</div>
<footer class="w3-padding-32 w3-black w3-center w3-margin-top">
  ...
  <p>Developed by <a href="#" target="_blank" class="w3-hover-text-green">ShivangiPandey</a></p>
</footer>
